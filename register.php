...
<body>
	<form action="" method="post">
		...
		<button type="submit" name="submit" class="submit" onclick="submit()">register</button>
</body>
...
if (isset($_POST['submit'])) {
	...
	//nakijken of die ingevult is


	// Poging uitvoeren query
	if ($conn->query($sql) === TRUE) {
		// Uitvoeren query gelukt
		//echo "<script>alert(`111 account toegevoegd 'users'.`)</script>";
