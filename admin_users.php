            ...
            <div class="content">
                ...
                ?>
                        ...
                        <div class="colom">
                            ...
                            echo $row['password'];
                            ?>
                            <a class="editbutton" href="./edit.php?id=<?php echo $row['id'];?>">Edit</a>
                            <a class="deletebutton" href="users_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure?')">Delete</a>
                        </div>
